    ...
    static class AdminMode
    {
        public static void Run(TestLauncher build)
        {
            ...
            if (runType == "" || runType == "1")
            {
                ...
                Console.WriteLine("\n\nType the name or number of the job (or comma seperated list of jobs). Leave blank to use default (Acceptance Testing)...");
            ...
            else if (runType == "2")
            {
                ...
                const int NumberOfServerTestJobs = 26;
                const int NumberOfReleaseResourcesTestJobs = 8;
