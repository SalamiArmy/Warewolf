    ...
    class Job_Definitions
    {
        public static Dictionary<string, Tuple<string, string>> GetJobDefinitions()
        {
            return new Dictionary<string, Tuple<string, string>>
            {
                ...
                ["Other Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable"),
                ["Infrastructure Unit Tests"] = new Tuple<string, string>("Dev2.Infrastructure.Tests", "Not Parallelizable"),
                ["Runtime Unit Tests"] = new Tuple<string, string>("Dev2.Runtime.Tests", "Not Parallelizable"),
                ["MS SQL Server Unit Tests"] = new Tuple<string, string>("Dev2.Runtime.Tests", "MSSql"),
                ["Core Unit Tests"] = new Tuple<string, string>("Dev2.Core.Tests", "Not Parallelizable"),
                ["Data Unit Tests"] = new Tuple<string, string>("Dev2.Data.Tests", "Not Parallelizable"),
                ["Parsing Unit Tests"] = new Tuple<string, string>("Warewolf.Parsing.Tests", "Not Parallelizable"),
                ["Storage Unit Tests"] = new Tuple<string, string>("Warewolf.Storage.Tests", "Not Parallelizable"),
                ["Studio Core Unit Tests"] = new Tuple<string, string>("Dev2.Studio.Core.Tests", "Not Parallelizable"),
                ["COMIPC Unit Tests"] = new Tuple<string, string>("Warewolf.COMIPC.Tests", "Not Parallelizable"),
                ["Studio View Models Unit Tests"] = new Tuple<string, string>("Warewolf.Studio.ViewModels.Tests", "Not Parallelizable"),
                ...
                ["Activity Designers Unit Tests"] = new Tuple<string, string>("Dev2.Activities.Designers.Tests", "Not Parallelizable"),
                ["Activities Unit Tests"] = new Tuple<string, string>("Dev2.Activities.Tests", "Not Parallelizable"),
