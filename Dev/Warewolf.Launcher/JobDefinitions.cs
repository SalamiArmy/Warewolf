...
namespace Warewolf.Launcher
{
    class Job_Definitions
    {
        public static Dictionary<string, Tuple<string, string>> GetJobDefinitions()
        {
            ...
            {
                //Unit Tests
                ["Acceptance Testing"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", null),
                ["Infrastructure Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Infrastructure Unit Tests"),
                ["Runtime Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Runtime Unit Tests"),
                ["MS SQL Server Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "MSSql"),
                ["Core Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Core Unit Tests"),
                ["Data Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Data Unit Tests"),
                ["Parsing Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Parsing Unit Tests"),
                ["Storage Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Storage Unit Tests"),
                ["Studio Core Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Studio Core Unit Tests"),
                ["COMIPC Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable COMIPC Unit Tests"),
                ["Studio View Models Unit Tests"] = new Tuple<string, string>("Warewolf.Studio.ViewModels.Tests", "Not Parallelizable Studio View Models Unit Tests"),
                ["Request Service Name View Models Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "RequestServiceNameViewModel"),
                ["Activity Designers Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Activity Designers Unit Tests"),
                ["Activities Unit Tests"] = new Tuple<string, string>("Dev2.*.Tests,Warewolf.*.Tests", "Not Parallelizable Activities Unit Tests"),
