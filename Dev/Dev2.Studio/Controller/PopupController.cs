...
namespace Dev2.Studio.Controller
{
    public class PopupController : Common.Interfaces.Studio.Controller.IPopupController
    {
        ...
        internal Func<string, string, MessageBoxButton, MessageBoxImage, string, bool, bool, bool, bool, List<string>, bool, bool, MessageBoxViewModel> ShowDev2MessageBox = Dev2MessageBoxViewModel.Show;
