...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class DeploySourceExplorerViewModelTests
    {
        ...
        public void TestEnvironmentSelectAll()
        {
            ...
            //assert
            _deployStatsViewerViewModel.Verify(it => it.TryCalculate(It.Is<IEnumerable<IExplorerTreeItem>>(list => list.Count() == 1 && list.Contains(explorerItemViewModelResourceCheckedMock.Object))));
        }
        ...
        public void TestSelectActionFolder()
        {
            ...
            _deployStatsViewerViewModel.Verify(
                it => it.TryCalculate(It.Is<IEnumerable<IExplorerTreeItem>>(match => !match.Any())));
        }
